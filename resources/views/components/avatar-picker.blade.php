    ...
    <input type="file" id="avatar-capture-input" name="avatar" accept="image/*" capture="environment" form="avatar-form" class="hidden" onchange="previewAvatar(this)">
    <input type="file" id="avatar-gallery-input" name="avatar" accept="image/*" form="avatar-form" class="hidden" onchange="previewAvatar(this)">
