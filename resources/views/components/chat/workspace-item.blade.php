...
<div data-workspace="{{ strtolower($name) }} {{ strtolower($meta) }}" class="flex items-center gap-2.5 px-3 py-2.5 cursor-pointer transition-all duration-150 hover:bg-white/5">
